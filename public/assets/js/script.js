...
const userpro=document.getElementById("userpro")
const userdrp=document.getElementById("user-drp")
const clspro= document.getElementById("clspro")
userpro.addEventListener("click",function(){
    userdrp.classList.add("user")
})
clspro.addEventListener("click", function () {
    setTimeout(function () {
        userdrp.classList.remove("user");
